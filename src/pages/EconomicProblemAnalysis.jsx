...
const translations = {
  si: {
    ...
    problem1Desc: 'කිසියම් ව්‍යාපාරිකයෙකු අර්බුදයකට ලක් වූ විට, බැංකු පද්ධතිය CRIB අසාදු ලේඛනගත කිරීම් සහ "අපරටේ" ප්‍රතිපාදන හරහා ඔහුගේ වත්කම් අත්පත් කරගනී. මෙමඟින් සිදුවන්නේ ව්‍යවසායකයා බියෙන් සහ සැකයෙන් පිරුණු, ආත්මවිශ්වාසයක් නොමැති තත්ත්වයට පත්වී මුළුමනින්ම අකර්මන්‍ය වීමයි.',
