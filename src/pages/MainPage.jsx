    ...
    <main className="pt-32 animate-fade">
      <section className="max-w-7xl mx-auto px-6 text-center py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div onClick={() => setCurrentPage('politics')} className="p-10 glass-card rounded-[2.5rem] border-orange-500/20 bg-orange-500/5 cursor-pointer">
          ...
          <div onClick={() => setCurrentPage('projects')} className="p-10 glass-card rounded-[2.5rem] border-green-500/20 bg-green-500/5 cursor-pointer">
